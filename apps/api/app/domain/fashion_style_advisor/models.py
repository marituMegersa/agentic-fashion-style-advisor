...
class AgenticFashionStyleAdvisorSession(Base):
    __tablename__ = "fashion_style_advisor_sessions"
...
class AgenticFashionStyleAdvisorItem(Base):
    __tablename__ = "fashion_style_advisor_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("fashion_style_advisor_sessions.id"))
